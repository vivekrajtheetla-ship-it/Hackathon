    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: "easeOut" }} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                <Card className="bg-white shadow-md border border-gray-200/80">
                    <CardHeader>
                        <div className="flex flex-wrap justify-between items-start gap-4">
                            <div>
                                <CardTitle className="text-3xl font-bold text-gray-800">{hackathon?.hackathon_name || "Loading Hackathon..."}</CardTitle>
                            ...
                            <div className="flex items-center gap-3">
                                <Button onClick={onNavigateToRegister} className="bg-blue-600 hover:bg-blue-700 text-white"><PlusCircle className="mr-2 h-4 w-4" /> Register New Team</Button>
...
const StatCard = ({ title, value, icon: Icon, color, onClick }) => (
    <Card
        className="bg-white shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-105"
        onClick={onClick}
    >
