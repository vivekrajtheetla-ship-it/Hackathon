...
export const getScoreById = async (req, res) => {
    try {
        ...
        if (!score) return res.status(NOT_FOUND).json({ message: 'Score not found' });
...
export const addScore = async (req, res) => {
    try {
        ...
        res.status(CREATED).json(savedScore);
    } catch (err) {
...
export const updateScore = async (req, res) => {
    try {
        ...
        if (!updated) return res.status(NOT_FOUND).json({ message: 'Score not found' });
...
export const deleteScore = async (req, res) => {
    try {
        ...
        if (!deleted) return res.status(NOT_FOUND).json({ message: 'Score not found' });
        res.status(OK).json({ message: 'Score deleted successfully' });
    } catch (err) {
        res.status(INTERNAL_SERVER_ERROR).json({ error: err.message });
    }
};